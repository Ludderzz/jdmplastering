...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const businessPhone = "447896560566"; 
    ...
    <div className="bg-white max-w-full overflow-x-hidden touch-pan-y">
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": {
              ...
              "areaServed": ["Nailsea", "Clevedon", "Portishead", "Bristol"],
              "address": {
                "@type": "PostalAddress",
      ...
      <section className="relative bg-slate-900 py-20 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <div className="inline-block px-4 py-1.5 mb-6 border border-amber-500/30 rounded-full bg-amber-500/10">
            <span className="text-amber-500 text-xs font-black uppercase tracking-[0.3em]">Somerset & Bristol</span>
          </div>
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg font-light leading-relaxed">
            Expert <span className="text-white">plastering and rendering in Nailsea</span>. Submit your project details below for an instant WhatsApp consultation.
          </p>
        </div>
      </section>

      {/* --- MAIN INTERACTION SECTION --- */}
      <main className="relative z-20 -mt-12 pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            
            {/* Left Column: Quick Info */}
            <aside className="lg:col-span-1 space-y-6">
              <address className="not-italic bg-slate-900 p-10 rounded-3xl text-white shadow-2xl border border-white/5">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold">Nailsea, Clevedon & Bristol</p>
                  </div>
                  <div>
                    <p className="text-amber-500 text-xs font-black uppercase tracking-widest mb-1">Availability</p>
              ...
              <div className="bg-amber-500 p-10 rounded-3xl shadow-xl">
                <h3 className="text-slate-900 text-2xl font-black mb-6">Simple 3-Step Process</h3>
                <ul className="space-y-4">
                  {[
                    { s: '01', t: 'Request', d: 'Send your project details below.' },
                    { s: '02', t: 'Review', d: 'We chat via WhatsApp or Phone.' },
                    { s: '03', t: 'Quote', d: 'Site visit and fixed-price quote.' }
                  ].map((step, i) => (
            ...
            <section className="lg:col-span-2 bg-white p-8 md:p-12 rounded-3xl shadow-2xl border border-slate-100">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <option>External Rendering (K-Rend/Weber)</option>
                      <option>Dry Lining & Partitioning</option>
                ...
                <div className="relative group">
                  <label className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2 block group-focus-within:text-amber-500 transition-colors">Project Details & Location</label>
                  <textarea 
                    name="details"
                    onChange={handleChange}
                    rows="4" 
                    ...
                    placeholder="Describe the job (e.g. 3 bed house exterior render in Clevedon)..." 
                    required
                  ></textarea>
                </div>
      ...
      <section className="bg-slate-50 py-12 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 opacity-60">
          <p className="text-xs font-black uppercase tracking-widest text-slate-900">JDM Plastering & Rendering Specialist</p>
          <div className="flex gap-8">
            <span className="text-xs font-black uppercase tracking-widest text-slate-900">Nailsea</span>
            <span className="text-xs font-black uppercase tracking-widest text-slate-900">Clevedon</span>
            <span className="text-xs font-black uppercase tracking-widest text-slate-900">Bristol</span>
          </div>
        </div>
      </section>
